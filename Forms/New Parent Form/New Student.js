function createElements(elementType = [], classes = [], attributes = [], values = [], text = [], flexType = "flexRow") {
  ...
  function createParentForm() {
    ...
    // Title
    questions.push(createElement("h2", "formTitle", [], [], "Parent Information"))

    // First Name
    questions.push(createElements(["label", "input"], ["label", "input"], [["for"], ["id"]], [["firstName"], ["firstName"]], ["First Name:", ""]));

    // Last Name
    questions.push(createElements(["label", "input"], ["label", "input"], [["for"], ["id"]], [["lastName"], ["lastName"]], ["Last Name:", ""]));

    // Phone Number
    questions.push(createElements(["label", "input"], ["label", "input"], [["for"], ["id"]], [["phoneNumber"], ["phoneNumber"]], ["Phone Number:", ""]));

    // Email Address
    questions.push(createElements(["label", "input"], ["label", "input"], [["for"], ["id"]], [["email"], ["email"]], ["Email Address:", ""]));

    // Place of Employment
    questions.push(createElements(["label", "input"], ["label", "input"], [["for"], ["id"]], [["employment"], ["employment"]], ["Place of Employment:", ""]));

    // How they heard of Wasatch Tutors
    questions.push(createElements(["label", "input"], ["label finalInput", "input finalInput"], [["for"], ["id"]], [["marketing"], ["marketing"]], ["How did you hear about us:", ""]));
    ...
    questions[questions.length - 1].querySelector("ul").appendChild(createElements(["li", "input", "text"], ["", "input miniBox", ""], [[], [], []], [[], [], []], ["If notice is not given the day prior, we understand that we <em>WILL</em> be charged for the full amount of the session.", "", "(initials)"]));
    ...
    for (let i = 0; i < questions.length; i++) {
      parentLocation.appendChild(questions[i]);
    };
