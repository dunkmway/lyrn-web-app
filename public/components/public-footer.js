const public_footer_template = document.createElement('template');
public_footer_template.innerHTML = `
    <footer>
        <div class="links">
        <div>
            <div>
...
class PublicFooter extends HTMLElement {
    constructor() {
        ...
        styles.href = "/components/public-footer.css"

        shadow.append(styles);
        shadow.append(public_footer_template.content.cloneNode(true))
    }
}
