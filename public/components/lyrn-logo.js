const lyrn_logo_template = document.createElement("template");
lyrn_logo_template.innerHTML = `
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="303 440 496 225" style="enable-background:new 0 0 1080 1080;" xml:space="preserve">
    <g>
...
class LyrnLogo extends HTMLElement {
    constructor() {
        super();
        const shadow = this.attachShadow({ mode: "open" });
        const styles = document.createElement('link');
        styles.rel = "stylesheet";
        styles.href = "/components/lyrn-logo.css"

        shadow.append(styles);
        shadow.append(lyrn_logo_template.content.cloneNode(true))
    }
}

customElements.define("lyrn-logo", LyrnLogo);